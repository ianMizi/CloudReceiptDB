/****** Object:  Procedure [dbo].[Enterprise_getAll]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Enterprise_getAll]
...
Select * from Enterprise order by EnterpriseName Asc
