/****** Object:  Procedure [dbo].[Notifications_InsertNotifications_SMS]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Notifications_InsertNotifications_SMS]  
...
BEGIN 
   ...
   set @AccountNo=(select CR_AccountNo  from CloudReceipts_MobileUser where CR_PhoneNumber=@PhoneNumber)
    set @AccountName=(select CR_AccountName  from CloudReceipts_MobileUser where CR_PhoneNumber=@PhoneNumber)
	...
	values (
	 @PhoneNumber,@Notification , @EnterpriseName ,
