/****** Object:  Procedure [dbo].[AyohaEnterprisesUserStatus_Load]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[AyohaEnterprisesUserStatus_Load]
...
Select * from AyohaEnterprisesUserStatus
