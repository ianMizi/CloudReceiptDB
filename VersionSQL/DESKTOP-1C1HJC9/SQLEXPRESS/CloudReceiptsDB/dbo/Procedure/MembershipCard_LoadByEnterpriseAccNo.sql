/****** Object:  Procedure [dbo].[MembershipCard_LoadByEnterpriseAccNo]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[MembershipCard_LoadByEnterpriseAccNo]
...
,[dbo].[Enterprises_GetEnterpriseAddress](@EnterpriseAccNo) as EnterpriseAddress
  ,[dbo].[Enterprises_getEnterpriseType](@EnterpriseAccNo) as EnterpriseType
   ...
   ,[dbo].[Memberships_isMembershipCodeExist](@AyohaUserAccountNo,MC.MembershipCardCode) as isMembershipCardSubscribed
