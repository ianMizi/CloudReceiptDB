/****** Object:  Procedure [dbo].[FlatReceiptsDetails_ByInvoiceNo]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[FlatReceiptsDetails_ByInvoiceNo]  
...
where t.FlatBillInvoiceNo=@InvoiceNo
...
--inner join CloudReceipts_MobileUser CM on t.FlatBillNumberIC = CM.CR_AccountNo inner join  Enterprise E on t.CloudreceiptAccNo=E.EnterpriseAccNo
--where t.FlatBillInvoiceNo='INV/CRKli-95115/8'
