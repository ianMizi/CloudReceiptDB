/****** Object:  Procedure [dbo].[Membership_LoadBySubscriberAccNo]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Membership_LoadBySubscriberAccNo]  
...
BEGIN 
   ...
   select M.ID, M.MembershipNo,SC.StampCampaignCode ,SC.StampCampaignName,SC.StartDate,SC.EndDate
  ...
  from 
  [dbo].[Membership] M inner join [dbo].[StampCampaign]  SC on  M.[CampaignCode] =SC.StampCampaignCode
