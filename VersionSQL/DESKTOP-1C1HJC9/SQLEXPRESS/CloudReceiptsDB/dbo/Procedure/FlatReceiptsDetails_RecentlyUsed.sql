/****** Object:  Procedure [dbo].[FlatReceiptsDetails_RecentlyUsed]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[FlatReceiptsDetails_RecentlyUsed]
@FlatReceiptsBSCloudreceiptAccountNo varchar (150)
...
Select top 10 * from FlatReceiptsDetails where FlatReceiptsBSCloudreceiptAccountNo=@FlatReceiptsBSCloudreceiptAccountNo  and isSent='Yes' order by ID desc
