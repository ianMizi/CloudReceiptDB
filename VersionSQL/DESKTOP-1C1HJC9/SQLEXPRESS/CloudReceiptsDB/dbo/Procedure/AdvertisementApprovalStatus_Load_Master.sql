/****** Object:  Procedure [dbo].[AdvertisementApprovalStatus_Load_Master]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[AdvertisementApprovalStatus_Load_Master]
...
Select * from AdvertisementApprovalStatus
