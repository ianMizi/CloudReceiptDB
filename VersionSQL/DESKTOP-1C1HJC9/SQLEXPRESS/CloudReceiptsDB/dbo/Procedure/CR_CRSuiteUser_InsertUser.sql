/****** Object:  Procedure [dbo].[CR_CRSuiteUser_InsertUser]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[CR_CRSuiteUser_InsertUser]  
...
BEGIN 
     SET NOCOUNT ON 
	   ...
	   INSERT INTO dbo.CloudReceipts_CRSuiteUser
          ( 
		  EnterpriseAccNo,
           UserName,	
	   	 Password ,
