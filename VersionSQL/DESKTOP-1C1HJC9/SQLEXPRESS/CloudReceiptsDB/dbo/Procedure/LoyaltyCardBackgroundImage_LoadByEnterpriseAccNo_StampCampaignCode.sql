/****** Object:  Procedure [dbo].[LoyaltyCardBackgroundImage_LoadByEnterpriseAccNo_StampCampaignCode]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[LoyaltyCardBackgroundImage_LoadByEnterpriseAccNo_StampCampaignCode]
...
Select * from LoyaltyCardBackgroundImage where EnterpriseAccNo=@EnterpriseAccNo and StampCampaignCode=@StampCampaignCode and RowStatus='Active' 
