/****** Object:  Procedure [dbo].[Receipt_getByIc]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Receipt_getByIc]
...
select  b.PlateNumber,b.VehicleModel ,b.CustomerName,b.CustomerIdentity,b.Mileage,b.TotalAmount,b.UTCBillDate,bd.BillId,bd.Quantity,bd.FlatBillDetails as Description,bd.Price,bd.Amount,ud.ReferralPerson,c.CompanyName from Bills b inner join BillDetails bd
  on b.BillId = bd.BillId
  inner join UserDetails ud on b.UserDetailId = ud.UserDetailId
inner join Companies c on c.CompanyId = ud.CompanyId
  where b.CustomerIdentity='1111111'
