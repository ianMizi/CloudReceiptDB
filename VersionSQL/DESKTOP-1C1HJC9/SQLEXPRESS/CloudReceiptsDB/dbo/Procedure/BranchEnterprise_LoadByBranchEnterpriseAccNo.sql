/****** Object:  Procedure [dbo].[BranchEnterprise_LoadByBranchEnterpriseAccNo]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[BranchEnterprise_LoadByBranchEnterpriseAccNo]
...
Select * from BranchEnterprise where BranchEnterpriseAccNo=@BranchEnterpriseAccNo and RowStatus='Active'
