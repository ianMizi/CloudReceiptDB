/****** Object:  Procedure [dbo].[ReceiptsAttachments_getByFlatReceiptsID]    Committed by VersionSQL https://www.versionsql.com ******/

create PROCEDURE [dbo].[ReceiptsAttachments_getByFlatReceiptsID]


@FlatReceiptsID as varchar(250)
...
Select Contents,FilesName from ReceiptsAttachments where FlatReceiptsID=@FlatReceiptsID
