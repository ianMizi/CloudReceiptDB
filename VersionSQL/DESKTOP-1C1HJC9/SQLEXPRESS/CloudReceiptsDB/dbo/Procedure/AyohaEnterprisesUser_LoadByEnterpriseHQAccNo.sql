/****** Object:  Procedure [dbo].[AyohaEnterprisesUser_LoadByEnterpriseHQAccNo]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[AyohaEnterprisesUser_LoadByEnterpriseHQAccNo]  
...
BEGIN 
     SET NOCOUNT ON 
	  	...
	  	select
     A.* from [dbo].[AyohaEnterprisesUser] A where A.EnterpriseAccNo=@EnterpriseHQAccNo and A.RowActive='Active'
