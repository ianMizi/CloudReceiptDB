/****** Object:  Procedure [dbo].[BranchEnterprise_LoadByEnterpriseAccNo]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[BranchEnterprise_LoadByEnterpriseAccNo]
...
Select * from BranchEnterprise where EnterpriseAccNo=@EnterpriseAccNo and RowStatus='Active'
