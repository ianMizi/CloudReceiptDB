/****** Object:  Procedure [dbo].[AyohaEnterprisesUserType_Load]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[AyohaEnterprisesUserType_Load]
...
Select * from AyohaEnterprisesUserType
