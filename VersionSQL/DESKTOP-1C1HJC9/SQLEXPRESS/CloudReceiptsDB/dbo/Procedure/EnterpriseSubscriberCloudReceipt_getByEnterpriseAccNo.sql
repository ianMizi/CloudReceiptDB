/****** Object:  Procedure [dbo].[EnterpriseSubscriberCloudReceipt_getByEnterpriseAccNo]    Committed by VersionSQL https://www.versionsql.com ******/

Create PROCEDURE [dbo].[EnterpriseSubscriberCloudReceipt_getByEnterpriseAccNo]  
...
BEGIN 
  ...
  on ES.SubcriberAccNo=CM.CR_AccountNo where ES.EnterpriseAccNo=@EnterpriseAccNo and Es.SubscribedCloudReceipt=1
