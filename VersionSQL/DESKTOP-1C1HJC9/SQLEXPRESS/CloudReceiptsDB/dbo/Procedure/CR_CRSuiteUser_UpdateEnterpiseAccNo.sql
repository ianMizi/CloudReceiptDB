/****** Object:  Procedure [dbo].[CR_CRSuiteUser_UpdateEnterpiseAccNo]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[CR_CRSuiteUser_UpdateEnterpiseAccNo]  
...
BEGIN 
  ...
  set EnterpriseAccNo=@EnterpriseAccNo
  Where ID=@ID 
