/****** Object:  Procedure [dbo].[Enterprise_getByEnterpriseAccNo]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[Enterprise_getByEnterpriseAccNo]
...
Select * from Enterprise where EnterpriseAccNo=@EnterpriseAccNo and RowStatus='Active'
