/****** Object:  View [dbo].[HotSeat_Advertisment]    Committed by VersionSQL https://www.versionsql.com ******/

Create View HotSeat_Advertisment as
...
E.EnterpriseCoordinate,E.EnterpriseTwiter,E.EnterpriseWebsite,E.PICContactNo
	...
	where A.AdvertisementStatus='Publishing' and A.AdvertisementType='Hot Seat'
...
E.EnterpriseCoordinate,E.EnterpriseTwiter,E.EnterpriseWebsite,E.PICContactNo
	...
	inner join Enterprises E on A.EnterpriseAccNo=E.EnterpriseAccNo 
	where A.AdvertisementStatus='Publishing' and A.AdvertisementType='Hot Seat') R
